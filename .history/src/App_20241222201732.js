  ...
  useEffect(() => {
    const connectToIoT = async () => {
      try {
        ...
        console.log("Access Key ID: ", iotClient.credentials.accessKeyId);
        console.log(
          "Secret Access Key: ",
          iotClient.credentials.secretAccessKey
        );
        console.log("Session Token: ", iotClient.credentials.sessionToken);
