...
function App() {
  ...
  const publishAllPids = async () => {
    try {
      ...
      const publishParams = {
        topic: "MAMDOUH", // Same topic for all PID values
        qos: 0,
  ...
  useEffect(() => {
    ...
    }, 100); // Fetch retained message every 5 seconds
    ...
    <div className="container">
      ...
      <div className="pid-container">
        <div className="pid-input">
          <label htmlFor="pidValue1"> P:</label>
          <input
            type="number"
            id="pidValue1"
            value={pidValue1}
      ...
      <div className="pid-container">
        <div className="pid-input">
          <label htmlFor="pidValue2">I:</label>
          <input
            type="number"
            id="pidValue2"
            value={pidValue2}
      ...
      <div className="pid-container">
        <div className="pid-input">
          <label htmlFor="pidValue3">D :</label>
          <input
            type="number"
            id="pidValue3"
            value={pidValue3}
